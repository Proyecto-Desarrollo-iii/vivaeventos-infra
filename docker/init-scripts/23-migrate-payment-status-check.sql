...
-- 2. Creamos la nueva restricción incluyendo todos los estados del Enum PaymentStatus
ALTER TABLE payments ADD CONSTRAINT payments_status_check
    CHECK (status IN ('PENDING', 'PROCESSING', 'APPROVED', 'DECLINED', 'FAILED', 'TIMEOUT', 'REFUNDED', 'CANCELLED', 'PAID'));
